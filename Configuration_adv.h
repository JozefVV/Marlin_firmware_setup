...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {50*60, 50*60, 4*60, 40} // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     95  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     95
  #define Y2_HYBRID_THRESHOLD    95
